<html>
    ...
    <body>
        <div class="body">
            ...
            <g:form controller="incident" method="post" >
            <div class="buttons">
                <div class="menuButton"><g:actionSubmit class="save" value="Update" /></div>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:incident,field:'gangMember','errors')}">
                                    <g:select optionKey="id" from="${GangMember.list()}" name="gangMember.id" value="${incident?.gangMember?.id}" ></g:select>
                                </td>
                            </tr> 
